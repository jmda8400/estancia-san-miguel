...
<div id="frontpageRoot" class="frontpage-simple">
    ...
    <section id="reservar" class="front-section-block front-section-row">
        ...
        <div class="front-section-content">
            ...
            <a href="{{ $whatsappUrl ?? "https://wa.me/5490000000000" }}" class="front-internal-btn" target="_blank" rel="noopener noreferrer">Reservar</a>
        </div>
    </section>
    ...
    <a href="{{ $whatsappUrl ?? "https://wa.me/5490000000000" }}" class="floating-whatsapp" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
